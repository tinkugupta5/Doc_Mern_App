...
const Template3 = () => {
  ...
  if (activeTemplate !== 'template3') return null;
  ...
  return (
    <div id="template-template3" className="template-container template3-bg template-active">
      <div className="watermark">PREVIEW</div>
      
      {shouldShowSection('photo') && (
        <div className="photo-box-standard" style={{ top: '185px', borderColor: '#b07e2a' }}>
          {photo ? (
            <img src={photo} className="w-full h-full object-cover" alt="Profile" />
          ) : (
            <div className="w-full h-full bg-orange-50 flex items-center justify-center text-orange-300 text-xs">📷 Photo</div>
          )}
        </div>
      )}
      ...
      <div className="template3-content">
        {shouldShowSection('personal', personalFields) && (
          <div className="w-[65%]">
            <div className="section-title-standard" style={{ color: '#b45309', borderLeft: '4px solid #b45309', paddingLeft: '12px', marginTop: 0 }}>{sectionLabels.personal}</div>
        ...
        {shouldShowSection('horoscope', horoscopeFields) && (
          <div className="mt-8">
            <div className="section-title-standard" style={{ color: '#b45309', borderLeft: '4px solid #b45309', paddingLeft: '12px' }}>{sectionLabels.horoscope}</div>
            <div className="w-[65%]">
        ...
        {shouldShowSection('family', familyFields) && (
          <div className="mt-8">
            <div className="section-title-standard" style={{ color: '#b45309', borderLeft: '4px solid #b45309', paddingLeft: '12px' }}>{sectionLabels.family}</div>
        ...
        {shouldShowSection('contact', contactFields) && (
          <div className="mt-8">
            <div className="section-title-standard" style={{ color: '#b45309', borderLeft: '4px solid #b45309', paddingLeft: '12px' }}>{sectionLabels.contact}</div>
        ...
        {shouldShowSection('other') && (
          <div className="mt-6">
            <div className="section-title-standard" style={{ color: '#b45309', borderLeft: '4px solid #b45309', paddingLeft: '12px', marginTop: 0 }}>{sectionLabels.other}</div>
            {customFields.map(f => (
